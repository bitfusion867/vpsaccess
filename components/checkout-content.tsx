          ...
          <Card className="rounded-2xl shadow-lg">
            <CardHeader className="text-center pb-4">
              <div className="flex items-center justify-center space-x-2">
                <CardTitle className="text-2xl font-bold text-foreground">{selectedPlan.name} Plan</CardTitle>
                {selectedPlan.popular && (
                  <Badge className="bg-purple-600 hover:bg-purple-700 text-white">Most Popular</Badge>
                )}
              </div>
              <CardDescription className="text-muted-foreground">{selectedPlan.description}</CardDescription>
              <div className="mt-4">
                ...
                <div className="pt-6 border-t">
                  <div className="bg-muted/50 rounded-2xl p-4 mb-6">
                    ...
                    <div className="flex justify-between items-center mt-2 pt-2 border-t border-border">
                      ...
                      <span className="font-bold text-xl text-foreground">${selectedPlan.price}.00</span>
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="rounded-2xl shadow-lg">
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Button variant="outline" size="sm" onClick={() => setSelectedCrypto(null)} className="rounded-xl">
                    Change
                  </Button>
                </div>
              </CardHeader>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-xl p-4">
                  <h4 className="font-semibold text-yellow-800 dark:text-yellow-200 mb-2">Payment Instructions:</h4>
